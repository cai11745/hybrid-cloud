---
layout: post
title: 关于 Markdown 的一些奇技淫巧（转载)
categories: Markdown
description: 介绍 Markdown 的一些高级用法。
keywords: Markdown, 奇技淫巧
---

本文copy自https://github.com/mzlogin/mzlogin.github.io/blob/master/_posts/2017-09-01-markdown-odd-skills.md

抄了这位大神的Jekyll blog模板，发现这篇介绍markdown的文章不错。
